...
const MoviesPage = () => {
  ...
  const { data: movies, isLoading, isError } = useQuery({
    queryKey: ['movies', type, page, searchQuery],
    queryFn: () => {
      if (searchQuery) {
        return fetchSearchMovies(searchQuery);
      }
      return fetchMoviesByType(type)(page);
    },
              ...
              >
                <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col justify-end p-4">
                  ...
                  <div className="flex items-center mt-2">
                    ...
                    <span className="text-white text-sm ml-2">{movie.quality}</span>
                  </div>
